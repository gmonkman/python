...
class Ugc(Base):
    ...
    txt = Column(String(2147483647, 'Latin1_General_CI_AS'), nullable=False, server_default='text("('')")')
    ...
    txt_cleaned = Column(String(2147483647, 'Latin1_General_CI_AS'), server_default='text("('')")')
    cleaned = Column(BIT)
