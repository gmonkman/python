...
"""./test_classification_pascal_rf.py --test-ds ~/data/PASCAL_2012/test/VOCdevkit/VOC2012/"""
...
def main(args):
    ...
    files = {
        label:
        open(results_dir + "/VOC2012/Main/comp1_cls_test_{}.txt".format(label),
             "w")
            ...
            try:
                ...
                while not coordinator.should_stop():
                    ...
                    for batch_elem_id in range(len(image_batch)):
                        ...
                        for label in set(set(pascal.CLASSES) - group.keys()):
                            files[label].write("{} {}\n".format(
                                decoded_filename, 0))
