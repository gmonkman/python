...
PAM_CORRS.extend(statslib.permuted_correlation(PAM_SCORES, PAM_DAYS, ITERATIONS))

TAU, CONF = scipy.stats.kendalltau(FMM_SCORES, FMM_YEAR)
FMM_CORRS.append([TAU, CONF])
FMM_CORRS.extend(statslib.permuted_correlation(FMM_SCORES, FMM_YEAR, ITERATIONS))
