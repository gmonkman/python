...
class WirralSeaFishingReportsSpider(Spider):
    ...
    '''
    name = "ports"
    source = 'http://ports.org.uk/allportstext.asp'
    allowed_domains = ['http://ports.org.uk']
    start_urls = ['http://ports.org.uk/allportstext.asp']
    base_url = 'http://ports.org.uk/allportstext.asp'
