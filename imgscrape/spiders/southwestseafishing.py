...
class SouthWestSeaFishingBoatSpider(Spider):
    '''scrape reports from angling addicts forum
    '''
    name = "southwestseafishing-afloat"
    source = 'www.southwestseafishing.co.uk'
    allowed_domains = ['southwestseafishing.co.uk']
    start_urls = ['https://www.southwestseafishing.co.uk/forum/boat-fishing/general-boat-fishing-talk'] #just a place holder to kick stuff off
    base_url = 'https://www.southwestseafishing.co.uk'
