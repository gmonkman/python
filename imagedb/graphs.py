...
def make_graph_dis_undis(csv, out):
    ...
    if 'bass' in csv:
        ax00.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.03, R$^2$=0.24', fontsize=TEXT_FONT_SIZE) #distorted background
        ax01.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.005, R$^2$=0.001', fontsize=TEXT_FONT_SIZE) #distorted foreground
        ax02.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.09, R$^2$=0.14', fontsize=TEXT_FONT_SIZE) #distorted laser

        ax10.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.03, R$^2$=0.13', fontsize=TEXT_FONT_SIZE) #undistorted background
        ax11.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.01 R$^2$=0.01', fontsize=TEXT_FONT_SIZE) #undistorted foreground
        ax12.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.05, R$^2$=0.23', fontsize=TEXT_FONT_SIZE) #undistorted laser
    else:
        ax00.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.04, R$^2$=0.61', fontsize=TEXT_FONT_SIZE) #distorted background
        ax01.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.17, R$^2$=0.80', fontsize=TEXT_FONT_SIZE) #distorted foreground
        ax02.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.26, R$^2$=0.95', fontsize=TEXT_FONT_SIZE) #distorted laser

        ax10.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.04, R$^2$=0.67', fontsize=TEXT_FONT_SIZE) #undistorted background
        ax11.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.08, R$^2$=0.76', fontsize=TEXT_FONT_SIZE) #undistorted foreground
        ax12.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.09, R$^2$=0.91', fontsize=TEXT_FONT_SIZE) #undistorted laser


    if 'bass' in csv:
        g.fig.text(0.03, 0.93, '(a)', transform=g.fig.transFigure, size='large', weight='bold')
    else:
        g.fig.text(0.03, 0.93, '(b)', transform=g.fig.transFigure, size='large', weight='bold')
...
def make_graphs_other(csv, out):
    ...
    #These results are from spss v_fid_long_form_all.spv
    if 'bass' in csv:
        ax00.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.04, R$^2$=0.10', fontsize=TEXT_FONT_SIZE_2) #foreground depth  size='smaller'
        ax01.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.02, R$^2$=0.05', fontsize=TEXT_FONT_SIZE_2) #laser depth

        ax10.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.02, R$^2$=0.03', fontsize=TEXT_FONT_SIZE_2) #foreground iterative
        ax11.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.01, R$^2$=0.01', fontsize=TEXT_FONT_SIZE_2) #laser iterative

        ax20.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.02, R$^2$=0.02', fontsize=TEXT_FONT_SIZE_2) #foreground profile
        ax21.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.01, R$^2$=0.03', fontsize=TEXT_FONT_SIZE_2) #laser profile

        ax30.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.0001, R$^2$<0.001', fontsize=TEXT_FONT_SIZE_2) #foreground sensor
        ax31.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.004, R$^2$=0.001', fontsize=TEXT_FONT_SIZE_2) #laser sensor

        ax40.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.01, R$^2$=0.01', fontsize=TEXT_FONT_SIZE_2) #foreground calib
        ax41.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.01, R$^2$=0.02', fontsize=TEXT_FONT_SIZE_2) #laser calib

    else:
        ax00.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.04, R$^2$=0.35', fontsize=TEXT_FONT_SIZE_2) #foreground depth
        ax01.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.02, R$^2$=-0.31', fontsize=TEXT_FONT_SIZE_2) #laser depth

        ax10.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.05, R$^2$=0.43', fontsize=TEXT_FONT_SIZE_2) #foreground iterative
        ax11.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.04, R$^2$=0.63', fontsize=TEXT_FONT_SIZE_2) #laser iterative

        ax20.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.01, R$^2$=0.06', fontsize=TEXT_FONT_SIZE_2) #foreground profile
        ax21.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.02, R$^2$=0.44', fontsize=TEXT_FONT_SIZE_2) #laser profile

        ax30.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.01, R$^2$=0.03', fontsize=TEXT_FONT_SIZE_2) #foreground sensor
        ax31.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=0.004, R$^2$=0.004', fontsize=TEXT_FONT_SIZE_2) #laser sensor

        ax40.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.02, R$^2$=0.22', fontsize=TEXT_FONT_SIZE_2) #foreground calib
        ax41.text(xlim[0] + spacer, ylim[1] - (y_spacer*2.2), 'b=-0.03, R$^2$=0.32', fontsize=TEXT_FONT_SIZE_2) #laser calib
    ...
    if 'bass' in csv:
        pass
        g.fig.text(-0.11, 0.965, '(a)', transform=g.fig.transFigure, size='large', weight='bold')
    else:
        pass
        g.fig.text(-0.11, 0.965, '(b)', transform=g.fig.transFigure, size='large', weight='bold')
...
def make_graphs_other2(csv, out):
    '''(str, str) -> void
    csv: csv file with data
    out: full filename to save the graph as
    '''
    ...
    if 'bass' in csv:
        pass
        g.fig.text(0.05, 0.965, '(a)', transform=g.fig.transFigure, size='large', weight='bold')
    else:
        pass
        g.fig.text(0.05, 0.965, '(b)', transform=g.fig.transFigure, size='large', weight='bold')
