...
def main(argv):
    ...
    cv2.createTrackbar(trackbar_label, image_window,
...
def MatchingMethod(param):
    ...
    cv2.rectangle(img_display, matchLoc,
                  (matchLoc[0] + templ.shape[0], matchLoc[1] + templ.shape[1]), (0, 0, 0), 2, 8, 0)
    cv2.rectangle(result, matchLoc, (matchLoc[0] + templ.shape[0],
