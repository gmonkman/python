    ...
    while True:
        ...
        if len(tracking_paths) > 0:
            ...
            feature_points_0 = np.float32(
                [tp[-1] for tp in tracking_paths]).reshape(-1, 1, 2)
            ...
            diff_feature_points = abs(
                feature_points_0 - feature_points_0_rev).reshape(-1, 2).max(-1)
            ...
            cv2.polylines(output_img, [np.int32(tp)
                                       for tp in tracking_paths], False, (0, 150, 0))
