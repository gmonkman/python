...
exclude_cb = {'anchorman 5', 'anchorman5', 'barracuda', 'bay surveyor', 'bayside', 'beowulf', 'bessie vee', 'better days', 'big buoy', 'bite', 'blazer 2', 'blue fin', 'blue marlin', 'blue mink', 'blue thunder', 'bluedawn', 'bluefin', 'blueye 2', 'bon amy', 'bonaventure ii', 'boney m', 'bonwey', 'bootlegger', 'bounty', 'boy carl', 'bramblewick', 'brigand', 'brighton diver', 'buccaneer', 'c cheetah', 'capriole', 'caroline', 'carrick lee', 'castaway', 'catch 22', 'celtic fox', 'celtic warrior', 'challenger 2', 'channel diver', 'channel warrior', 'charisma', 'che sara sara', 'chieftain', 'chinook 11', 'chinook 3', 'chocolate', 'chrisanda', 'cleveland princess', 'cloud nine', 'crimson tide', 'cumbrae', 'danda', 'danny boy', 'daphne carole', 'dawn breaker', 'dawn mist', 'dawn raider', 'dawn tide', 'deep blue', 'defiant', 'dentex', 'diablo', 'discovery', 'dointhedo', 'dolly p', 'dominator', 'duchess ii', 'duke iv', 'dulcie t', 'eastern promise', 'eastern promise 2', 'elegance', 'emma jayne', 'emma kate', 'endeavour', 'enterprise', 'escapade', 'excalibur', 'excel 2', 'famous', 'final answer', 'fire fox', 'fish on', 'fishon', 'flamer iv', 'force 10', 'foxy lady', 'freedom', 'galloper', 'gemini 3', 'gemini ii', 'girl gray', 'girl mandy', 'glad tidings', 'gloria b11', 'goldrush', 'great escape', 'great white', 'grey viking', 'hard labour', 'heartbeat', 'heidi j', 'hermit', 'high flyer', 'highlander', 'hurricane', 'hvita', 'independent', 'jay jay', 'jean k', 'jenifers pride', 'jensen', 'jfk two', 'jo dan', 'jojo', 'jolly fisherman', 'jolly roger', 'just mary', 'kaimalino', 'katie ann', 'katrina', 'kelleys hero charters', 'kellys hero', 'kelsey leigh', 'kimberley', 'kingfisher', 'kraken', 'lady ann', 'lady anne', 'lady elsie', 'lady grace', 'lady helen', 'lady lucy ii', 'lady mary', 'lady of the lake', 'last laugh', 'lead us', 'libby', 'lone shark', 'louise jane', 'lynander', 'mac', 'madonna', 'malaki', 'manta ray', 'marie f', 'marlin', 'mary ellen', 'maverick', 'meerkat', 'mersey lass', 'michelle mary', 'mirage', 'mistress', 'mistress linda', 'misty blue', 'misty lady', 'moonraker', 'moonshine', 'morgan james', 'morgan m', 'morning breeze', 'mystique', 'nemesis', 'neptune', 'never can tell a', 'north star', 'oberon', 'obsession', 'ocean crusader', 'ocean explorer', 'ocean runner', 'offshore rebel iv', 'on a promise', 'optimist', 'orca', 'osprey', 'osprey ii', 'our gemma', 'our joel', 'our joy', 'out the blue', 'outlaw', 'pace arrow', 'panther', 'pathfinder', 'peace and plenty', 'peganina', 'pegasus', 'pioneer', 'piscary', 'piscine', 'plan b', 'porbeagle', 'portia', 'predator', 'pride and joy', 'progress', 'providence', 'queensferry', 'rachel k', 'rapid fisher', 'razorbill 3', 'red 5', 'reecer', 'reel action', 'reel deal', 'robert mark', 'rocket', 'royal charlotte', 'royal eagle', 'saltwind', 'samuel irvin 3', 'sapphire', 'sarah michelle', 'saxon lady', 'scooby doo too', 'sea angler ii', 'sea breeze 3', 'sea fever', 'sea fire', 'sea fox', 'sea leopard', 'sea otter 2', 'sea searcher', 'sea spray', 'sea swift', 'sea tradar', 'sea urchin ii', 'seajuicer', 'seawatch 1', 'secret star', 'seeker', 'serenity', 'shaking', 'shalimar', 'shande iii', 'she likes it 2', 'she likes it ii', 'she likes it rough 2', 'shokwave', 'silver sea', 'silver spray', 'size matters', 'skerry belle', 'skylark', 'snapper', 'sophie lea', 'southern angler', 'southern star', 'sovereign', 'spirit of arun', 'spot on', 'starfish', 'stoney broke', 'striker', 'strongbow', 'sunrise', 'supanova', 'supanova ii', 'susie b', 'suveran', 'swordfish', 'tamesis', 'tango', 'telmar', 'tempus fugit', 'the african queen', 'thresher', 'tiger', 'tina dawn', 'tj gannet', 'top cat', 'torbay belle', 'tracy jane', 'trio 3', 'trio iii', 'trio lll', 'trot on', 'true blue', 'trueblue', 'tuskar', 'two dogs', 'typhoon', 'unity', 'upholder', 'valkyrie', 'venture', 'venus', 'viking', 'voyager', 'waderbay', 'wandering star', 'warlord', 'warrior', 'wave dancer', 'wetwheels', 'white maiden', 'white maiden ii', 'white marlin', 'why worry', 'wight huntress', 'wight rebel', 'wight sapphire', 'wight spirit', 'wild frontier', 'yellowfin'}
