...
l = _clean(['Aces High', 'Adelaide', 'Adventuress', 'Ailish', 'Alba Deep', 'Aldeburgh Angler', 'Alexia', 'Ali-Cat', 'All Aboard M.F.V. fulmar II', 'Alliance', 'Als Spirit', 'Als Spirit', 'AlyKat', 'Amaretto III', 'Amaretto IV', 'Amarisa', 'Amatheia', 'Amino', 'Angelus', 'Anglo Dawn III', 'Anne Clare', 'Aquavitesse', 'Aquila', 'Aries 3', 'Aries II', 'Atlanta', 'Atlantic Blue', 'Atlantic Diver', 'Atlantic Explorer', 'Atlantis', 'Atlantis', 'Bachanalian', 'Barracuda', 'Bay Surveyor', 'Bayside', 'Becca-Marie', 'Beowulf', 'Bessie Vee', 'Better Days', 'Big Buoy', 'Bite', 'Blazer 2', 'Blue Duo', 'Blue Fin', 'Blue Marlin', 'Blue Mink', 'Blue Thunder', 'Blue Turtle', 'Bluedawn', 'Bluefin', 'Blueye 2', 'Bon Amy', 'Bonaventure II', 'Boney M', 'Bonwey', 'Bootlegger', 'Bounty', 'Bounty Hunter', 'Boy Carl', 'Boy Richard', 'Bramblewick', 'Branscombe Pearl', 'Brigand', 'Brightlingsea Fishing Charters', 'Brighton Diver', 'Buccaneer', 'C Cheetah', 'Capriole', 'Caroline', 'Carrick Lee', 'Carrie Jane', 'Castaway', 'Catch 22', 'Celtic Fox', 'Celtic Warrior', 'Challenger 2', 'Channel Cheiftain 5', 'Channel Diver', 'Channel Warrior', 'Charisma', 'Charlotte Louise', 'Che Sara Sara', 'Chieftain', 'Chinook 11', 'Chinook 3', 'Chinquita', 'Chocolate', 'Chrisanda', 'Christine Ann', 'Christyann', 'Cleveland Princess', 'Cloud Nine', 'Cobra 3', 'Cobra III', 'Crimson Tide', 'Crusader 2', 'Cumbrae', 'Dakala Mist', 'Danda', 'Danny Boy', 'Dannyboy II', 'Danse De Leau', 'Daphne Carole', 'Dawn Breaker', 'Dawn Mist', 'Dawn Raider', 'Dawn Tide', 'DAWN TIDE II', 'Dawn Venture', 'Deep Blue', 'Defiant', 'Delta Sunrise.', 'Dentex', 'Dentex lll', 'Diablo', 'Discovery', 'Dointhedo', 'Dolly P', 'Dominator', 'Double Six', 'Drakkar', 'Duchess II', 'Duke IV', 'Dulcie T', 'Dusk Diver', 'Eastern Promise', 'Eastern Promise 2', 'Edwin John', 'Elegance', 'Emma Jayne', 'Emma Kate', 'Endeavour', 'Enterprise', 'Enterprise', 'Escapade', 'Evelyn Jane II', 'Evelyn-Jane', 'Excalibur', 'Excel 2', 'Famous', 'Final Answer', 'Fins-up', 'Fire Fox', 'Fish On!', 'Fish-On!', 'Flamer IV', 'Flamer 4', 'Folkestone Voyager', 'Force 10', 'Foxy Lady', 'Frances Jane', 'Freedom', 'Galloper', 'Gemini 3', 'Gemini II', 'George Griffiths MBE', 'Girl Gray', 'Girl Mandy', 'Glad Tidings', 'Gloria B11', 'Gold-Rush', 'Great Escape', 'Great White', 'Grey Fox', 'Grey Viking', 'Gypsy 2', 'Hard Labour', 'Heartbeat', 'Heidi J', 'Hermit', 'Hermit of Hythe', 'High Flyer', 'High Flyer 2', 'Highlander', 'Hurricane', 'Hvita', 'Independent', 'In-T-Net', 'Jay Jay', 'Jean K', 'Jenifers Pride', 'Jensen', 'Jensen & Suveran', 'Jessica Hettie', 'JFK TWO', 'Jo Dan', 'Jo-Dan', 'Joint Venture', 'Jo-Jo', 'Jolly Fisherman', 'Jolly Roger', 'Joy Belle', 'Jozilee', 'Jubrae', 'Julie D', 'Just Mary', 'Kaimalino', 'Kaimalino', 'Karyl-Anne', 'Katie Ann', 'Katrina', 'Kayleigh-L', 'Kelleys Hero Charters', 'Kellys Hero', 'Kelsey Leigh', 'Kimberley', 'Kingfisher', 'Kingfisher', 'Kingfisher & Equaliser', 'Kingfisher II', 'Kittiwake 3', 'Kraken', 'Lady Ann', 'Lady Anne', 'Lady D', 'Lady Elsie', 'Lady Essex III', 'Lady Grace', 'Lady Helen', 'Lady Lucy II', 'Lady Mary', 'Lady Of The Lake', 'Lady Sarah', 'Lady Tina', 'Last Laugh', 'Laura III', 'Lead Us', 'Lesley Jane', 'Libby', 'Lillie May', 'Lily Lolo', 'Lizy', 'Lone Shark', 'Lone Shark III', 'Louise Jane', 'Lowestoft Provider', 'Lynander', 'M.F.V. Fulmar', 'M.F.V. Tamesis', 'M.V. Penetrater', 'Madonna', 'Malaki', 'Manta Ray', 'Margaret Elaine', 'Marie F', 'Marlin', 'Mary Ellen', 'Maverick', 'Meerkat', 'Meerkat', 'Mermaid II', 'Mersey Lass', 'Mia Jay', 'Michelle Mary', 'Mirage', 'Miss Patty', 'Missy Moo', 'Mistress', 'Mistress', 'Mistress Linda', 'Misty Blue', 'Misty Lady', 'Moonraker', 'Moonshine', 'Morgan James', 'Morgan M', 'Morning Breeze', 'MV Freedom', 'Mystique', 'Mystique II', 'Natalie Kristen II', 'Nemesis', 'Neptune', 'Never Can Tell A', 'North Star', 'Nova Stella.', 'Oberon', 'Obsession', 'Ocean Crusader', 'Ocean explorer', 'Ocean Lass', 'Ocean Runner', 'Ocean Warrior 3', 'Ocean-Pearl II', 'Offshore Rebel IV', 'On A Promise', 'Optimist', 'Optimist', 'Orca', 'Osprey', 'Osprey', 'Osprey & TeddieBoy', 'Osprey II', 'Our Gemma', 'Our Joe-L', 'Our Joy', 'Out Rage', 'Out The Blue', 'Outlaw', 'Pace Arrow', 'Panther', 'Panther', 'Pathfinder', 'Patrice II', 'Patricia Rose', 'Peace & Plenty', 'Peganina', 'Pegasus', 'Penetrater', 'Pioneer', 'Piscary', 'Piscine', 'PLAN B', 'Portia', 'Predator', 'Predator', 'Predator', 'Predator', 'Pride and Joy', 'Private Venture', 'Progress', 'Providence', 'Purdy and Flamer 2', 'Queensferry', 'Racheal Jane', 'Rachel K', 'Random Harvest II', 'Rapid Fisher', 'Razorbill  3', 'Razorbill 3', 'Red 5', 'Reecer', 'Reel Action', 'Reel Deal', 'Restorick III', 'Robert Mark', 'Rose-Ann', 'Rose-Ann', 'Rough Diamond 2', 'Royal Charlotte', 'Royal Eagle', 'Ruby-D', 'Sally Ann', 'Sally Ann', 'Sally Ann Jo', 'Saltwind', 'Sambe', 'Samuel Irvin 3', 'San Gina I', 'San Gina II', 'Sapphire', 'Sapphire charters sunderland', 'Sarah Michelle', 'Saxon Lady', 'Scooby Doo Too', 'Sea  Leopard', 'Sea Angler II', 'Sea Breeze 3', 'Sea Fever', 'Sea Fire ', 'Sea Fox', 'Sea Leopard', 'Sea Leopard', 'Sea Otter 2', 'Sea Searcher', 'Sea Spray', 'Sea swift', 'Sea Tradar', 'Sea Urchin II', 'Sea Urchin IIl', 'Seabreeze 3', 'Seabreeze III', 'Sea-Juicer', 'Sea-Otter 2', 'Seawatch 1', 'Secret Star', 'Seeker', 'Senija', 'Serenity', 'Serenity', 'Sha-King', 'Shalimar', 'Shande 3', 'Shande III', 'She Likes It 2', 'She Likes It II', 'She Likes It Rough 2', 'Shogun (Marna Marine)', 'Shokwave', 'Shy-Torque III', 'Silver Halo', 'Silver Sea', 'Silver Spray', 'Size Matters', 'Skerry Belle', 'Skylark', 'Snapper', 'Snowstar', 'Sophie Lea', 'Southern Angler', 'Southern Star', 'Spirit Of Arun', 'Sportsmans Night', 'Spot On!', 'Stoney Broke', 'Striker', 'Supanova', 'Supanova II', 'Susie B', 'Suveran', 'Swallow IV', 'Swin Ranger', 'Swordfish', 'T.J. Gannet', 'T.J.Gannet', 'Tamesis', 'Tango', 'Taxi Boat Charters Poseidon', 'Telmar', 'Telmar II', 'Tempus Fugit', 'The African Queen', 'Thistle B', 'Three Sisters', 'Three Sisters', 'Threesisters', 'Thresher', 'Tiger', 'Tiger Lily', 'Tina Dawn', 'Top Cat', 'Top Cat III', 'TopCat Charters', 'Toplines', 'Torbay Belle', 'Tracy Jane', 'Trio 3', 'Trio III', 'TRIO lll', 'Trojan Warrior Whitby', 'Trot On', 'TROT- ON', 'True Blue', 'Trueblue', 'Trya II', 'Tuonela', 'Tuskar', 'Two Dogs', 'Unity', 'Upholder', 'Valkyrie', 'Venture', 'Venus', 'Viking', 'Voyager', 'Waderbay', 'Wandering Star', 'Warlord', 'Warrior', 'Wave Cheiftain', 'Wave Dancer', 'Wetwheels', 'White Maiden', 'White Maiden II', 'White Marlin', 'Why Worry', 'Wight Huntress', 'Wight Rebel', 'Wight Sapphire', 'Wight Spirit', 'Wild Frontier', 'Wild Frontier 2', 'Yellowfin', 'Yorkshire Lass', 'Yorkshire Lass II', 'Yorkshire Rose', 'Yorkshireman'])
l = [n.lower() for n in l]
l = _nlpbase.expansions(l, {'2': ['ii'], '3': ['iii'], '4': ['iv'], 'ii':['2'], 'iii':['3'], 'iv':['4'], 'M.F.V.':['MFV'], 'MFV.':['M.F.V.']})
...
l = _clean(['Aces High', 'Adelaide', 'Adventuress', 'Ailish', 'Alba Deep', 'Aldeburgh Angler', 'Alexia', 'Ali-Cat', 'All Aboard M.F.V. fulmar II', 'Alliance', 'Als Spirit', 'Als Spirit', 'AlyKat',
            'Amaretto III', 'Amaretto IV', 'Amarisa', 'Amatheia', 'Amino', 'Angelus', 'Anglo Dawn III', 'Anne Clare', 'Aquavitesse', 'Aquila', 'Aries 3', 'Aries II', 'Atlanta',
            'Atlantic Blue', 'Atlantic Diver', 'Atlantic Explorer', 'Atlantis', 'Atlantis', 'Bachanalian', 'Barracuda', 'Bay Surveyor', 'Bayside', 'Becca-Marie', 'Beowulf',
            'Bessie Vee', 'Better Days', 'Big Buoy', 'Bite', 'Blazer 2', 'Blue Duo', 'Blue Fin', 'Blue Marlin',
            'Blue Mink', 'Blue Thunder', 'Blue Turtle', 'Bluedawn', 'Bluefin', 'Blueye 2', 'Bon Amy', 'Bonaventure II', 'Boney M', 'Bonwey', 'Bootlegger', 'Bounty', 'Bounty Hunter', 'Boy Carl', 'Boy Richard',
            'Bramblewick', 'Branscombe Pearl', 'Brigand', 'Brightlingsea Fishing Charters', 'Brighton Diver', 'Buccaneer', 'C Cheetah', 'Capriole', 'Caroline', 'Carrick Lee', 'Carrie Jane', 'Castaway',
            'Catch 22', 'Celtic Fox', 'Celtic Warrior', 'Challenger 2', 'Channel Cheiftain 5', 'Channel Diver', 'Channel Warrior', 'Charisma', 'Charlotte Louise', 'Che Sara Sara', 'Chieftain', 'Chinook 11',
            'Chinook 3', 'Chinquita', 'Chocolate', 'Chrisanda', 'Christine Ann', 'Christyann', 'Cleveland Princess', 'Cloud Nine', 'Cobra III', 'Crimson Tide', 'Crusader 2', 'Cumbrae',
            'Dakala Mist', 'Danda', 'Danny Boy', 'Dannyboy II', 'Danse De Leau', 'Daphne Carole', 'Dawn Breaker', 'Dawn Mist', 'Dawn Raider', 'Dawn Tide', 'DAWN TIDE II', 'Dawn Venture', 'Deep Blue',
            'Defiant', 'Delta Sunrise.', 'Dentex', 'Dentex lll', 'Diablo', 'Discovery', 'Dointhedo', 'Dolly P', 'Dominator', 'Double Six', 'Drakkar', 'Duchess II', 'Duke IV', 'Dulcie T', 'Dusk Diver',
            'Eastern Promise', 'Eastern Promise 2', 'Edwin John', 'Elegance', 'Emma Jayne', 'Emma Kate', 'Endeavour', 'Enterprise', 'Escapade', 'Evelyn Jane II', 'Evelyn-Jane', 'Excalibur',
            'Excel 2', 'Final Answer', 'Fins-up', 'Fire Fox', 'Fish On!', 'Fish-On!', 'Flamer IV', 'Flamer 4', 'Folkestone Voyager', 'Force 10', 'Foxy Lady', 'Frances Jane', 'Galloper', 'Gemini 3',
            'Gemini II', 'George Griffiths MBE', 'Girl Gray', 'Girl Mandy', 'Glad Tidings', 'Gloria B11', 'Gold-Rush', 'Great Escape', 'Grey Fox', 'Grey Viking', 'Gypsy 2', 'Hard Labour',
            'Heartbeat', 'Heidi J', 'Hermit of Hythe', 'High Flyer', 'High Flyer 2', 'Highlander', 'Hvita', 'Independent', 'In-T-Net', 'Jay Jay', 'Jean K', 'Jenifers Pride',
            'Jensen', 'Jensen & Suveran', 'Jessica Hettie', 'JFK TWO', 'Jo Dan', 'Jo-Dan', 'Joint Venture', 'Jo-Jo', 'Jolly Fisherman', 'Jolly Roger', 'Joy Belle', 'Jozilee', 'Jubrae', 'Julie D',
            'Just Mary', 'Kaimalino', 'Kaimalino', 'Karyl-Anne', 'Katie Ann', 'Katrina', 'Kayleigh-L', 'Kelleys Hero Charters', 'Kellys Hero', 'Kelsey Leigh', 'Kimberley', 'Kingfisher', 'Kingfisher',
            'Kingfisher & Equaliser', 'Kingfisher II', 'Kittiwake 3', 'Kraken', 'Lady Ann', 'Lady Anne', 'Lady D', 'Lady Elsie', 'Lady Essex III', 'Lady Essex 3', 'Lady Grace', 'Lady Helen', 'Lady Lucy II', 'Lady Lucy 2', 'Lady Mary',
            'Lady Of The Lake', 'Lady Sarah', 'Lady Tina', 'Last Laugh', 'Laura III', 'Lead Us', 'Lesley Jane', 'Libby', 'Lillie May', 'Lily Lolo', 'Lizy', 'Lone Shark', 'Lone Shark III', 'Louise Jane',
            'Lowestoft Provider', 'Lynander', 'M.F.V. Fulmar', 'M.F.V. Tamesis', 'M.V. Penetrater', 'Madonna', 'Malaki', 'Manta Ray', 'Margaret Elaine', 'Marie F', 'Marlin', 'Mary Ellen', 'Maverick',
            'Meerkat', 'Mermaid II', 'Mersey Lass', 'Mia Jay', 'Michelle Mary', 'Mirage', 'Miss Patty', 'Missy Moo', 'Mistress', 'Mistress', 'Mistress Linda', 'Misty Blue', 'Misty Lady',
            'Moonraker', 'Moonshine', 'Morgan James', 'Morgan M', 'Morning Breeze', 'MV Freedom', 'Mystique', 'Mystique II', 'Natalie Kristen II', 'Nemesis', 'Neptune', 'Never Can Tell A', 'North Star',
            'Nova Stella.', 'Oberon', 'Obsession', 'Ocean Crusader', 'Ocean explorer', 'Ocean Lass', 'Ocean Runner', 'Ocean Warrior 3', 'Ocean-Pearl II', 'Offshore Rebel IV', 'On A Promise',
            'Optimist', 'Orca', 'Osprey', 'Osprey & TeddieBoy', 'Osprey II', 'Our Gemma', 'Our Joe-L', 'Our Joy', 'Out Rage', 'Out The Blue', 'Outlaw', 'Pace Arrow', 'Panther',
            'Pathfinder', 'Patrice II', 'Patricia Rose', 'Peace & Plenty', 'Peganina', 'Pegasus', 'Penetrater', 'Pioneer', 'Piscary', 'Piscine', 'PLAN B', 'Portia', 'Predator', 'Predator',
            'Predator', 'Pride and Joy', 'Private Venture', 'Progress', 'Providence', 'Purdy and Flamer 2', 'Queensferry', 'Racheal Jane', 'Rachel K', 'Random Harvest II', 'Rapid Fisher', 
            'Razorbill  3', 'Razorbill 3', 'Red 5', 'Reecer', 'Reel Action', 'Reel Deal', 'Restorick III', 'Robert Mark', 'Rose-Ann', 'Rose-Ann', 'Rough Diamond 2', 'Royal Charlotte',
            'Royal Eagle', 'Ruby-D', 'Sally Ann', 'Sally Ann', 'Sally Ann Jo', 'Saltwind', 'Sambe', 'Samuel Irvin 3', 'San Gina I', 'San Gina II', 'Sapphire',
            'Sarah Michelle', 'Saxon Lady', 'Scooby Doo Too', 'Sea  Leopard', 'Sea Angler II', 'Sea Breeze 3', 'Sea Fever', 'Sea Fire ', 'Sea Fox', 'Sea Leopard', 'Sea Otter 2',
            'Sea Searcher', 'Sea Spray', 'Sea swift', 'Sea Tradar', 'Sea Urchin II', 'Sea Urchin III', 'Seabreeze 3', 'Seabreeze III', 'Sea breeze III', 'Sea-Juicer', 'Sea-Otter 2', 'Seawatch 1', 'Secret Star', 'Seeker', 'Senija',
            'Serenity', 'Serenity', 'Sha-King', 'Shalimar', 'Shande 3', 'Shande III', 'She Likes It 2', 'She Likes It II', 'She Likes It Rough 2', 'Shogun (Marna Marine)', 'Shokwave', 'Shy-Torque III',
            'Silver Halo', 'Silver Sea', 'Silver Spray', 'Size Matters', 'Skerry Belle', 'Skylark', 'Snapper', 'Snowstar', 'Sophie Lea', 'Southern Angler', 'Southern Star', 'Spirit Of Arun',
            'Sportsmans Night', 'Spot On!', 'Stoney Broke', 'Striker', 'Supanova', 'Supanova II', 'Susie B', 'Suveran', 'Swallow IV', 'Swin Ranger',
            'Swordfish', 'T.J. Gannet', 'T.J.Gannet', 'Tamesis', 'Tango', 'Taxi Boat Charters Poseidon', 'Telmar', 'Telmar II', 'Tempus Fugit', 'The African Queen', 'Thistle B', 'Three Sisters',
            'Three Sisters', 'Threesisters', 'Thresher', 'Tiger', 'Tiger Lily', 'Tina Dawn', 'Top Cat', 'Top Cat III', 'TopCat Charters', 'Toplines', 'Torbay Belle', 'Tracy Jane', 'Trio 3',
            'Trio III', 'TRIO 3', 'Trojan Warrior Whitby', 'Trot On', 'TROT-ON', 'True Blue', 'Trueblue', 'Trya II', 'Tuonela', 'Tuskar', 'Two Dogs', 'Unity', 'Upholder', 'Valkyrie',
            'Venture', 'Venus', 'Viking', 'Voyager', 'Waderbay', 'Wandering Star', 'Warlord', 'Warrior', 'Wave Cheiftain', 'Wave Dancer', 'Wetwheels', 'White Maiden', 'White Maiden II', 'White Marlin',
            'Why Worry', 'Wight Huntress', 'Wight Rebel', 'Wight Sapphire', 'Wight Spirit', 'Wild Frontier', 'Wild Frontier 2', 'Yellowfin', 'Yorkshire Lass', 'Yorkshire Lass II', 'Yorkshire Rose',
            ])
