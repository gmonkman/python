...
def test_statslib():
    '''test stats
    '''
    res = statslib.permuted_teststat_check(
        r"C:\Users\Graham Monkman\OneDrive\Documents\PHD\My Papers\WalesRSA-MSP\data\focalcorr\fmm_0_20160716180726.csv",
        0,
        0)
...
def testbinning():
    ...
    a[0] = numpy.nan
    a[99] = numpy.nan
    aout = statslib.quantile_bin(
        a, percentiles=[
            25, 50, 75], zero_as_zero=True)
# endregion
