...
# numpy array filled with 100 random points, ie 100,2
class_2 = 1.2 * randn(n, 2) + array([5, 1])
# greats numpy array 1 x 200  filled with 100 ones (0:100) and 100 -1s
# (100:200)
...
with open('./data/points_ring_10.pkl', 'wb') as f:
    pickle.dump(class_1, f)
    # plt.scatter(class_2[0:100,0:1],class_2[0:100,1:2])
    pickle.dump(class_2, f)
    pickle.dump(labels, f)
