...
from solem.PCV.localdescriptors import sift
...
# set this to the path where you downloaded the panoramio images
download_path = "panoimages"
# path to save thumbnails (pydot needs the full system path)
path = "/FULLPATH/panoimages/"
